...
const EducationComponent = ({
  ...
  return (
    <div className="border border-blue-900 hover:border-gray-500 md:p-5 p-3 rounded-md transition-all duration-1000 ease-in-out shadow-sm shadow-blue-900 group">
