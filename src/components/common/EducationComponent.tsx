...
import { EducationComponentProps } from "../../types";
  ...
  return (
    <div className="border-t border-b border-blue-900 hover:border-gray-500 md:p-5 p-3 rounded-md transition-all duration-1000 ease-in-out shadow-sm shadow-blue-900 group">
      <div className="flex gap-3 items-center">
        <img src={image} className="w-16 h-16 rounded-md" alt={course} />
        <div>
      ...
      <p className="mt-3 text-sm md:text-base text-gray-300 md:line-clamp-none line-clamp-3 group-hover:line-clamp-none transition-all duration-1000 ease">
        {description}
      </p>
