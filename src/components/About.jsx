  ...
  return (
    <div className="my-8 md:my-20 flex flex-col about section" id="about">
      <div>
        ...
        <p className="text-center text-md md:text-xl lg:w-[50%] m-auto mt-2 md:mt-4" id="user-detail-intro">
      ...
      >
        <p className="md:w-[90%] font-normal md:leading-9 user-detail-intro">
          ...
          front-end, and back-end development. Technical expertise spans <span className="font-medium">Java,
          JavaScript, CSS, HTML, REST API, React, Axios, Tailwind CSS, and
          Node.js Express.</span> Demonstrated problem-solving prowess with over 500+
          DSA problems solved. Passionate about crafting efficient and elegant
          code, with a proven track record in both front-end and back-end
          development. Excels in problem-solving and relishes the opportunity to
          collaborate with teams to build innovative solutions. Ready to
          leverage technology to transform ideas into reality.
        </p>
      </div>
    </div>
  );
