    ...
    >
      <div className="text-center sm:text-left">
        <div className="xl:text-5xl lg:text-4xl text-3xl text-white font-semibold">
          <h1>Hii there👋,</h1>
          <h1 className="my-1" id="user-detail-name">
            I am Mohd Salman
          </h1>
        </div>
        ...
        <p className="md:font-medium xl:text-xl lg:text-lg sml:text-md sm:text-left md:mt-3 mt-0 text-center user-detail-intro">
          ...
          results. With a positive mindset and a hunger for growth, I&apos;m
          geared up to make a significant impact and accomplish awesome things.
        </p>
