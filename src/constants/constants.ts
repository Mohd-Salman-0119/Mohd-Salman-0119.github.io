...
export const projects: Project[] = [
  {
    ...
    description:
      "HomeHarbor is a MERN app redefining how we discover homes. Seamlessly explore, compare, and connect with diverse housing options, enhancing your journey to finding the perfect dwelling. Elevate your housing search with HomeHarbor, simplifying the process for a more connected living experience.",
    disabled: true,
  },
  {
    image: bewakoofSite,
    ...
    description:
      "Welcome to Bewakoof – where style and personality collide in a vibrant online haven. Our eclectic collection celebrates individuality, offering clothes, accessories, and more that know no boundaries. Each piece tells a unique story, resonating with the bold, expressive, and bewakoof spirit within you. Experience fashion beyond limits.",
  ...
  },
  {
    ...
    techStack: ["HTML", "CSS", "Firebase", "Razorpay"],
    flexRow: "lg:flex-row-reverse",
  },
  {
    image: educationSite,
    ...
    description:
      "Welcome to our educational hub, a catalyst for intellectual growth. Dive into our curated resources, providing a foundation for learning. Your feedback is invaluable as we continually refine and improve. Join us on this enlightening journey of discovery.",
...
export const experience: Experience[] = [
  ...
  },
  {
    ...
    description:
      "Completed intensive 6-week Core Java training at Internshala. Specialized in desktop application development.",
    image: internshalaImage,
    skills: "Java, JavaFX, XML",
  },
];

export const handleVisitGitHub = (): void => {
  window.open("https://github.com/Mohd-Salman-0119", "_blank");
};

export const handleDwonloadResume = (): void => {
  const ancher = document.createElement("a");
  ancher.download = "Mohd-Salman-Resume.pdf";
  ancher.href = myResume;
  ancher.click();
  window.open(
    "https://drive.google.com/file/d/1JAZZ8oLZSLgi-XN4Vdj-G59M-an5gXbw/view?usp=sharing",
    "_blank"
  );
};

export const handleVisitEmail = (): void => {
  window.open("mailto:salmanansari910550@gmail.com");
};

export const handleVisitLinkedIn = (): void => {
